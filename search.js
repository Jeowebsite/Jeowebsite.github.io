...
{ title: "Fortz", onclick: "window.open('https://bonbang.github.io/store3/fortz/', '_blank')" },
{ title: "Cyber Cars Punk Racing", onclick: "window.open('https://bonbang.github.io/store3/cyber-cars-punk-racing/', '_blank')" },
{ title: "Air Hockey Champion Deluxe", onclick: "window.open('https://bonbang.github.io/air-hockey-championship-deluxe/', '_blank')" },
{ title: "Bike Trials Winter", onclick: "window.open('https://bonbang.github.io/store2/bike-trials-winter-1/', '_blank')" },
{ title: "Bumber Car Soccer", onclick: "window.open('https://bonbang.github.io/bumper-cars-soccer/', '_blank')" },
{ title: "City Drive Stunt Car Master", onclick: "window.open('https://bonbang.github.io/city-car-driving-stunt-master/', '_blank')" },
{ title: "City Driver", onclick: "window.open('https://bonbang.github.io/store2/city-rider/', '_blank')" },
{ title: "Grind Craft", onclick: "window.open('https://bonbang.github.io/store1/grindcraft/', '_blank')" },
{ title: "Gravity Soccer", onclick: "window.open('https://bonbang.github.io/store3/gravity-soccer/', '_blank')" },
{ title: "Gun Mayhem", onclick: "window.open('https://bonbang.github.io/store5/gun-mayhem/', '_blank')" },
{ title: "Gun Mayhem 2", onclick: "window.open('https://bonbang.github.io/store5/gun-mayhem-2/', '_blank')" },
{ title: "Gun Mayhem 3", onclick: "window.open('https://bonbang.github.io/store5/gun-mayhem-3/', '_blank')" },
{ title: "Gun Spin", onclick: "window.open('https://bonbang.github.io/store5/gunspin/', '_blank')" },
{ title: "G switch 3", onclick: "window.open('https://h5cdn.github.io/s4/g-switch-3/', '_blank')" },
{ title: "Stick Climb 2", onclick: "window.open('https://h5cdn.github.io/s6/stickman-climb-2/#abc', '_blank')" },
{ title: "High Way Traffic", onclick: "window.open('https://h5cdn.github.io/s7/highway-traffic/', '_blank')" },
{ title: "Murder", onclick: "window.open('https://h5cdn.github.io/s5/murder/', '_blank')" },
{ title: "We Become What We Behold", onclick: "window.open('https://h5cdn.github.io/s3/we-become-what-we-behold/', '_blank')" },
{ title: "Stick Man Bike", onclick: "window.open('https://h5cdn.github.io/s6/stickman-bike/', '_blank')" },
{ title: "Dread Head Parkour", onclick: "window.open('https://h5cdn.github.io/s7/dreadhead-parkour/', '_blank')" },
{ title: "Idle Digging Tycoon", onclick: "window.open('https://h5cdn.github.io/s5/idle-digging-tycoon/', '_blank')" },
{ title: "Run 3 Remake", onclick: "window.open('https://h5cdn.github.io/s9/run-3-editor/', '_blank')" },
{ title: "Brain Test", onclick: "window.open('https://h5cdn.github.io/s2/brain-test-tricky-puzzles/', '_blank')" },
{ title: "Tiger Simulator", onclick: "window.open('https://h5cdn.github.io/s3/tiger-simulator-3d/', '_blank')" },
{ title: "Stcik Man Hook", onclick: "window.open('https://h5cdn.github.io/s/stickman-hook/', '_blank')" },
{ title: "Offroader 5V", onclick: "window.open('https://h5cdn.github.io/s5/offroader-v5/', '_blank')" },
{ title: "Raft Wars", onclick: "window.open('https://h5cdn.github.io/s/raft-wars/', '_blank')" },
{ title: "Cluster Rush", onclick: "window.open('https://h5cdn.github.io/s8/cluster-rush/', '_blank')" },
{ title: "Idle Startup Tycoon", onclick: "window.open('https://h5cdn.github.io/s5/idle-startup-tycoon/', '_blank')" },
{ title: "Color Water Sort", onclick: "window.open('https://h5cdn.github.io/s3/water-color-sort/', '_blank')" },
{ title: "Fancy Pants 2", onclick: "window.open('https://h5cdn.github.io/s4/fancy-pants-2/', '_blank')" },
{ title: "Fancy Pants 3", onclick: "window.open('https://h5cdn.github.io/s4/fancy-pants-3/', '_blank')" },
